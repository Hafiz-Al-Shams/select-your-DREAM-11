    ...
    return (
        <div className="flex justify-between items-center pt-14 pb-10 w-[99%]">
            ...
            <div>
                ...
                <button className='btn border-2 text-black border-gray-50 p-4 rounded-xl font-bold hover:text-gray-500' style={{ backgroundColor: 'rgb(231, 254, 41)' }}>Selected {"(0)"}</button>
            </div>
        </div>
    )
}
