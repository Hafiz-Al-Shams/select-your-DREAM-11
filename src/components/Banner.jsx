...
export default function Banner() {
    return (
        <div className='bg-cover bg-no-repeat rounded-2xl w-full py-14 text-center space-y-5 bg-black' style={{ backgroundImage: `url(${background})` }}>
            ...
            <button className='btn border-2 border-gray-50 p-4 rounded-xl font-bold hover:text-gray-500' style={{ backgroundColor: 'rgb(231, 254, 41)' }}>Claim Free Credit</button>
        </div>
    )
}
